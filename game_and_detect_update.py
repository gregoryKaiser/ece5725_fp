...
hero_im = pygame.transform.scale(hero_im,(25,50))
hero_im_l = pygame.image.load("leftBoy.png")
hero_im_l = pygame.transform.scale(hero_im_l,(25,50))
...
while run : #main game loop
    ...
    if GAME_STATE==MENU_SCREEN: #first menu screen
        ...
        time.sleep(3)
        #reset hero
        hero = classes.character(hero_im_l, hero_im, 50, 50, 50, 50, 25, 50)
        hero.speedx = 0
        hero.speedy = 2
