...
GPIO.add_event_detect(23, GPIO.BOTH, callback=move_hero_right, bouncetime=300)
GPIO.add_event_detect(27, GPIO.FALLING, callback=move_hero_left, bouncetime=300)
